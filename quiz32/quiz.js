...
var questions = [
    ...
    {
        id: 2,
        question: "The medication is __________ for use by both adults and children.",
        chinese_question: "这种药物对成人和儿童都 __________ 。",
        answers: [
    ...
    {
        id: 6,
    question: "The engineer assured the team that constructing the bridge within the given timeframe was __________.",
    chinese_question: "工程师向团队保证，在给定的时间范围内建造桥梁是 __________ 的。",
    answers: [

...
var questions = [
    ...
    {
        id: 2,
    question: "The investigation revealed that the new employee was an __________ who had faked his credentials to get the job.",
    chinese_question: "调查显示，这名新员工是一个 __________，他伪造了自己的资历以获得这份工作。",
    answers: [
        ...
        { option: "D", answer: "impostor", chinese_answer: "冒名顶替者", chinese_romanization: "màomíng dǐngtì zhě" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'impostor' means a person who pretends to be someone else in order to deceive others." +
        "<br><br>" +
        ...
        "<br><br>" +
        "(C) 'scholar' means a specialist in a particular branch of study, especially the humanities.",
    chinese_explanation: "(D) '冒名顶替者' 意味着一个假装是别人以欺骗他人的人。" +
        "<br><br>" +
        "(A) '新手' 意味着一个在某一领域或情况下新手或没有经验的人。" +
        "<br><br>" +
        "(B) '老手' 意味着在某一特定领域有长期经验的人。" +
        "<br><br>" +
        "(C) '学者' 意味着在特定学科，特别是人文学科方面的专家。"
    },
    {
        id: 3,

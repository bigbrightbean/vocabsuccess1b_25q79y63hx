...
var questions = [
    ...
    },
    {
        ...
        correctAnswer: "B",
        explanation: "(B) 'pious' means showing great respect for religious or moral principles." +
            "<br><br>" +
        ...
        chinese_explanation: "(B) '虔诚的' 意味着对宗教或道德原则表现出极大的尊重。" +
            "<br><br>" +
            "(A) '怀疑的' 意味着不容易被说服的；有疑问或保留意见的。" +
            "<br><br>" +
            "(C) '漠不关心的' 意味着没有特别的兴趣或同情；不关心的。" +
            "<br><br>" +
            "(D) '无私的' 意味着不受个人利益考虑的影响。"
    },
    {
        id: 9,
    ...
    {
        id: 10,
        question: "The mediator remained __________ throughout the negotiations, ensuring a fair discussion.",
        chinese_question: "调解人在整个谈判过程中保持 __________，确保了公平的讨论。",
        answers: [
            { option: "A", answer: "biased", chinese_answer: "有偏见的", chinese_romanization: "yǒu piānjiàn de" },
            ...
            { option: "D", answer: "prejudiced", chinese_answer: "有成见的", chinese_romanization: "yǒu chéngjiàn de" }
        ],
        correctAnswer: "C",
        explanation: "(C) 'neutral' means not supporting or helping either side in a conflict, disagreement, etc.; impartial." +
            "<br><br>" +
            "(A) 'biased' means unfairly prejudiced for or against someone or something." +
            "<br><br>" +
        ...
        chinese_explanation: "(C) '中立的' 意味着不支持或帮助冲突、争论等中的任何一方；公正的。" +
            "<br><br>" +
            "(A) '有偏见的' 意味着对某人或某事不公平地有偏见。" +
            "<br><br>" +
            "(B) '偏袒的' 意味着在争议中偏向一方；有偏见的。" +
            "<br><br>" +
            "(D) '有成见的' 意味着具有或表现出源于偏见的厌恶或不信任的。"
    }
];

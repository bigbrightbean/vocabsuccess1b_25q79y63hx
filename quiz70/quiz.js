...
var questions = [
    ...
    {
        id: 6,
    question: "The company decided to introduce a small __________ in salaries, effective from next month, to reward employees for their hard work and dedication.",
    chinese_question: "公司决定从下个月起对员工的工资进行小幅 __________，以奖励他们的辛勤工作和奉献精神。",
    answers: [
        { option: "A", answer: "decrease", chinese_answer: "减少", chinese_romanization: "jiǎnshǎo" },
        { option: "B", answer: "deduction", chinese_answer: "扣除", chinese_romanization: "kòuchú" },
        { option: "C", answer: "reduction", chinese_answer: "缩减", chinese_romanization: "suōjiǎn" },
        { option: "D", answer: "increment", chinese_answer: "增加", chinese_romanization: "zēngjiā" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'increment' means an increase or addition, especially one of a series on a fixed scale." +
        "<br><br>" +
        "(A) 'decrease' means to make or become smaller or fewer in size, amount, intensity, or degree." +
        "<br><br>" +
        "(B) 'deduction' means the action of deducting or subtracting something." +
        "<br><br>" +
        "(C) 'reduction' means the action or fact of making something smaller or less in amount, degree, or size.",
    chinese_explanation: "(D) '增加' 意味着增加或添加，尤其是一系列按固定比例增加中的一个。" +
        "<br><br>" +
        "(A) '减少' 意味着使或变得更小或更少的大小、数量、强度或程度。" +
        "<br><br>" +
        "(B) '扣除' 意味着扣除或减去某物的动作。" +
        "<br><br>" +
        "(C) '缩减' 意味着使某物变小或减少的动作或事实。"
    },
    {
        id: 7,
    ...
    {
        id: 8,
    question: "The scandal exposed __________ between the government officials and private contractors, who conspired to embezzle public funds and manipulate contracts.",
    chinese_question: "丑闻揭示了政府官员和私人承包商之间的 __________，他们共谋挪用公款和操纵合同。",
    answers: [
        ...
        { option: "D", answer: "collusion", chinese_answer: "共谋", chinese_romanization: "gòngmóu" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'collusion' means secret or illegal cooperation or conspiracy in order to deceive others." +
        "<br><br>" +
        "(A) 'honesty' means the quality of being truthful and sincere." +
        "<br><br>" +
        "(B) 'transparency' means the condition of being transparent or open." +
        "<br><br>" +
        "(C) 'integrity' means the quality of being honest and having strong moral principles.",
    chinese_explanation: "(D) '共谋' 意味着秘密或非法合作或阴谋以欺骗他人。" +
        "<br><br>" +
        "(A) '诚实' 意味着真实和真诚的品质。" +
        "<br><br>" +
        "(B) '透明' 意味着透明或开放的状态。" +

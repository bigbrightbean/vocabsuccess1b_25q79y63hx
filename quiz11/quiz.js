...
var questions = [
    ...
    {
        id: 8,
        question: "The __________ figure of the jolly man in the red suit is easily recognizable during the holiday season.",
        chinese_question: "穿红衣服的快乐男人的 __________ 身影在假日期间很容易辨认。",
        answers: [
            { option: "A", answer: "slim", chinese_answer: "苗条的", chinese_romanization: "miáotiáo de" },
            { option: "B", answer: "rotund", chinese_answer: "圆胖的", chinese_romanization: "yuánpàng de" },
            { option: "C", answer: "lean", chinese_answer: "瘦的", chinese_romanization: "shòu de" },
            { option: "D", answer: "skinny", chinese_answer: "瘦骨嶙峋的", chinese_romanization: "shòugǔlínxún de" }
        ],
        correctAnswer: "B",
        explanation: "(B) 'rotund' means (of a person) plump." +
            "<br><br>" +
            "(A) 'slim' means gracefully thin." +
            "<br><br>" +
            "(C) 'lean' means (of a person or animal) thin, especially healthily so; having no superfluous fat." +
            "<br><br>" +
            "(D) 'skinny' means unattractively thin and bony.",
        chinese_explanation: "(B) '圆胖的' 意味着（人）丰满的。" +
            "<br><br>" +
            "(A) '苗条的' 意味着优雅地瘦的。" +
            "<br><br>" +
            "(C) '瘦的' 意味着（人或动物）瘦的，尤其是健康地瘦；没有多余的脂肪。" +
            "<br><br>" +
            "(D) '瘦骨嶙峋的' 意味着不吸引人地瘦和骨感的。"
    },
    {
        id: 9,

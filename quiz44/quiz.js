...
var questions = [
    ...
    {
        id: 3,
        question: "The climbers were __________ in their efforts to reach the summit.",
        chinese_question: "登山者在努力到达顶峰时表现得非常__________。",
        answers: [
    ...
    {
        id: 6,
        question: "The teacher's __________ instructions left no room for questions, clearly outlining the task.",
        chinese_question: "老师的 __________ 指示不留任何疑问，清楚地说明了任务。",
        answers: [
    ...
    {
        id: 10,
        question: "The gas leak was __________, but it posed a significant danger to everyone in the building.",
        chinese_question: "气体泄漏是 __________ 的，但对大楼里的每个人都构成了重大危险。",
        answers: [
            ...
            { option: "D", answer: "clear", chinese_answer: "清楚", chinese_romanization: "qīngchǔ" }
        ],
        correctAnswer: "A",

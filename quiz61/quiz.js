...
var questions = [
    ...
    {
        id: 2,
        question: "The __________ in her eyes was clear as she watched her friend win the award.",
        chinese_question: "当她看着朋友获奖时，眼中的 __________ 显而易见。",
        answers: [
    ...
    },
    {
        ...
        answers: [
            ...
            { option: "C", answer: "illusion", chinese_answer: "幻觉", chinese_romanization: "huànjué" },
        ...
        explanation: "(A) 'levitation' means the action of rising or causing something to rise and hover in the air, typically by means of supposed magical powers." +
            "<br><br>" +
            "(B) 'deception' means the act of deceiving someone." +
            "<br><br>" +
            "(C) 'illusion' means a thing that is or is likely to be wrongly perceived or interpreted by the senses." +
            "<br><br>" +
    ...
    {
        id: 8,
        question: "The tech __________ predicted that the new smartphone would revolutionize the market with its innovative features.",
        chinese_question: "这位科技 __________ 预测，新款智能手机将以其创新功能彻底改变市场。",
        answers: [
            { option: "A", answer: "beginner", chinese_answer: "初学者", chinese_romanization: "chūxué zhě" },
            { option: "B", answer: "pundit", chinese_answer: "专家", chinese_romanization: "zhuānjiā" },
            { option: "C", answer: "student", chinese_answer: "学生", chinese_romanization: "xuéshēng" },
    ...
    {
        id: 9,
        question: "The detective uncovered the criminal's elaborate __________ to steal the priceless artifact.",
        chinese_question: "侦探揭露了罪犯精心策划的 __________，试图偷走无价的文物。",
        answers: [

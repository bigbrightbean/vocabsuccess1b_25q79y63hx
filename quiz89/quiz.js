...
var questions = [
    {
        id: 1,
    question: "The voters __________ the mayor for failing to keep his campaign promises.",
    chinese_question: "选民们 __________ 市长没有履行竞选承诺。",
    answers: [
    ...
    {
        id: 4,
    question: "The teacher's encouraging words served to __________ the students' spirits before the exam.",
    chinese_question: "老师鼓励的话语在考试前 __________ 了学生们的情绪。",
    answers: [
    ...
    {
        id: 5,
        question: "In order to maintain a healthy lifestyle, she decided to __________ junk food.",
        chinese_question: "为了保持健康的生活方式，她决定 __________ 垃圾食品。",
        answers: [
    ...
    {
        id: 6,
    question: "He would __________ over the coach, hoping to be chosen as the team captain.",
    chinese_question: "他会 __________ 教练，希望被选为队长。",
    answers: [
    ...
    {
        id: 7,
    question: "The company's logo was __________ on all the employee uniforms to promote brand visibility.",
    chinese_question: "公司的标志被 __________ 在所有员工制服上，以提升品牌知名度。",
    answers: [
    ...
    {
        id: 8,
        question: "The rebels managed to __________ the dictator and establish a new government.",
        chinese_question: "叛军设法 __________ 独裁者，建立了一个新政府。",
        answers: [
    ...
    {
        id: 9,
    question: "The gymnast could __________ her body into seemingly impossible positions.",
    chinese_question: "这名体操运动员可以将她的身体 __________ 成看似不可能的姿势。",
    answers: [

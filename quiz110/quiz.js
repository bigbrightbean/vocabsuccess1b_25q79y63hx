...
var questions = [
    ...
    {
        id: 2,
    question: "The politician was __________ by the public after the scandal, facing harsh criticism from all sides.",
    ...
    {
        id: 4,
    question: "He could not __________ any details of the dream he had last night.",
    chinese_question: "他无法 __________ 昨晚梦到的任何细节。",
    answers: [
    ...
    {
        id: 5,
    question: "The chef takes pride in his restaurant’s ability to __________ the finest seafood.",
    chinese_question: "这位厨师以他的餐厅能够 __________ 最好的海鲜而自豪。",
    answers: [
    ...
    {
        id: 8,
        question: "The scientist was able to __________ the theory with new evidence from her experiments.",
        chinese_question: "科学家能够用她的实验新证据 __________ 这一理论。",
        answers: [

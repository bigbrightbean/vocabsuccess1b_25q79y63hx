...
var questions = [
    {
        ...
        answers: [
            ...
            { option: "B", answer: "sell", chinese_answer: "销售", chinese_romanization: "xiāoshòu" },
            { option: "C", answer: "manufacture", chinese_answer: "生产", chinese_romanization: "shēngchǎn" },
            { option: "D", answer: "neglect", chinese_answer: "忽视", chinese_romanization: "hūlüè" }
        ],
        correctAnswer: "C",
        explanation: "(C) 'manufacture' means to make something, especially on a large scale using machinery." +
            "<br><br>" + 
            "(A) 'destroy' means to put an end to the existence of something." +
            "<br><br>" + 
            "(B) 'sell' means to give or hand over something in exchange for money." +
            "<br><br>" + 
            "(D) 'neglect' means to fail to care for properly.",
        chinese_explanation: "(C) '生产' 意味着制作某物，尤其是使用机械大规模制作。" +
            "<br><br>" + 
            "(A) '破坏' 意味着终结某物的存在。" +
            "<br><br>" + 
            "(B) '销售' 意味着用钱交换物品。" +
    ...
    {
        id: 5,
    question: "Farmers __________ on good weather for a successful harvest, as it significantly influences crop growth.",
    chinese_question: "农民 __________ 好天气来获得丰收，因为它显著影响作物生长。",
    answers: [
    ...
    answers: [
        ...
        { option: "B", answer: "rewarded", chinese_answer: "奖励", chinese_romanization: "jiǎnglì" },
        { option: "C", answer: "upbraided", chinese_answer: "斥责", chinese_romanization: "chìzé" },
        { option: "D", answer: "encouraged", chinese_answer: "鼓励", chinese_romanization: "gǔlì" }
    ],
    correctAnswer: "C",
    explanation: "(C) 'upbraided' means to scold or criticize someone severely." +
        "<br><br>" +
        "(A) 'praised' means to express warm approval or admiration." +
        "<br><br>" +
        "(B) 'rewarded' means to give something to someone in recognition of their services, efforts, or achievements." +
        "<br><br>" +
        "(D) 'encouraged' means to give support, confidence, or hope to someone.",
    chinese_explanation: "(C) '斥责' 一词意味着严厉地责骂或批评某人。" +
        "<br><br>" +
        "(A) '赞美' 意味着表示热烈的赞同或钦佩。" +
        "<br><br>" +

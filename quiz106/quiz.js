...
var questions = [
    {
        id: 1,
    question: "The judge decided to __________ the criminal for his involvement in the robbery.",
    chinese_question: "法官决定 __________ 这名罪犯，因为他参与了抢劫。",
    answers: [
    ...
    {
        id: 3,
    question: "The nurse was always ready to __________ the doctors during surgeries.",
    chinese_question: "护士总是准备好在手术期间 __________ 医生。",
    answers: [
    ...
    {
        id: 6,
    question: "Despite their best efforts, the team __________ to win the championship.",
    chinese_question: "尽管他们尽了最大的努力，球队还是 __________ 夺冠。",
    answers: [
    ...
    {
        id: 7,
        question: "The flower’s sweet fragrance __________ throughout the garden.",
        chinese_question: "花朵的甜美香气 __________ 整个花园。",
        answers: [
    ...
    {
        id: 8,
        question: "His bad habits began to __________ his health over time.",
        chinese_question: "他的坏习惯随着时间的推移开始 __________ 他的健康。",
        answers: [

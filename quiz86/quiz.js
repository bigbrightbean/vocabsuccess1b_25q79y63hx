...
var questions = [
    ...
    {
        id: 3,
    question: "After reviewing the incident, the school decided to __________ the student's suspension by revoking the previous decision and allowing the student to return to classes.",
    chinese_question: "在审查事件后，学校决定通过撤销之前的决定并允许学生返回课堂来 __________ 学生的停学处分。",
    answers: [
    ...
    {
        id: 4,
    question: "He decided to take a short vacation to __________ from the stress of work and recharge his energy.",
    chinese_question: "他决定休个短假来 __________ 工作的压力，并恢复他的精力。",
    answers: [
    ...
    {
        id: 5,
    question: "The organization aimed to __________ all traces of corruption from its ranks by implementing strict policies and conducting regular audits to ensure transparency.",
    chinese_question: "该组织旨在通过实施严格的政策和进行定期审计来 __________ 队伍中的所有腐败痕迹，以确保透明度。",
    answers: [

...
var questions = [
    ...
    answers: [
        ...
        { option: "D", answer: "agitate", chinese_answer: "激怒", chinese_romanization: "jīnù" }
    ],
    correctAnswer: "B",
    ...
    {
        id: 5,
    question: "The artist's work __________ his personal experiences and emotions.",
    chinese_question: "这位艺术家的作品 __________ 了他的个人经历和情感。",
    answers: [
        ...
        { option: "D", answer: "contradicted", chinese_answer: "矛盾", chinese_romanization: "máodùn" }
    ],
    correctAnswer: "A",
    explanation: "(A) 'reflected' means to show an image of; to demonstrate." +
        ...
        "<br><br>" +
        "(D) 'contradicted' means to be in conflict with.",
    ...
    {
        id: 6,
        question: "The manager decided to __________ the urgent documents to the client as soon as possible.",
        chinese_question: "经理决定尽快将紧急文件 __________ 给客户。",
        answers: [
    ...
    {
        id: 7,
        question: "The teacher asked other students to __________ the story that the boy was telling about the fight.",
        chinese_question: "老师让其他学生来 __________ 男孩讲述的关于打架的故事。",
        answers: [
        ...
        explanation: "(A) 'corroborate' means to confirm or give support to (a statement, theory, or finding)." +
            ...
            "<br><br>" +
            "(D) 'deny' means to state that one refuses to admit the truth or existence of.",
    ...
    {
        id: 9,
        question: "The information __________ to your health should be taken seriously.",
        chinese_question: "与您的健康有关的信息应认真对待。",
        answers: [
            ...
            { option: "C", answer: "dismissing", chinese_answer: "驳回", chinese_romanization: "bóhuí" },
            { option: "D", answer: "excluding", chinese_answer: "排除", chinese_romanization: "páichú" }
        ],
        correctAnswer: "A",
        explanation: "(A) 'pertaining' means to be appropriate, related, or applicable." +
            ...
            "<br><br>" +
            "(C) 'dismissing' means to order or allow to leave; send away." +
            "<br><br>" +
            "(D) 'excluding' means to deny (someone) access to or bar (someone) from a place, group, or privilege.",
        chinese_explanation: "(A) '涉及' 意味着相关或适用。" +
            ...
            "(C) '驳回' 意味着命令或允许离开；送走。" +
            "<br><br>" +
            "(D) '排除' 意味着拒绝（某人）进入或阻止（某人）享有某地、群体或特权。"
    },
    {
        id: 10,

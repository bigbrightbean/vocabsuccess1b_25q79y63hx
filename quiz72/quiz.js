...
var questions = [
    ...
    {
        id: 10,
        question: "The table had a beautiful __________ that made it look like it was made of solid oak.",
        chinese_question: "桌子有一个漂亮的 __________，让它看起来像是用实心橡木制成的。",
        answers: [
            { option: "A", answer: "finish", chinese_answer: "表面", chinese_romanization: "biǎomiàn" },
            { option: "B", answer: "coating", chinese_answer: "涂层", chinese_romanization: "túcéng" },
            { option: "C", answer: "layer", chinese_answer: "层", chinese_romanization: "céng" },
            { option: "D", answer: "veneer", chinese_answer: "饰面", chinese_romanization: "shìmiàn" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'veneer' means a thin decorative covering of fine wood applied to a coarser wood or other material." +
            "<br><br>" +
            "(A) 'finish' means the final coating or surface treatment of a material." +
            "<br><br>" +
            "(B) 'coating' means a layer of a substance spread over a surface." +
            "<br><br>" +
            "(C) 'layer' means a sheet, quantity, or thickness of material, typically one of several, covering a surface or body.",
        chinese_explanation: "(D) '饰面'一词意味着一种精细木材的薄装饰覆盖，应用于较粗糙的木材或其他材料。" +
            "<br><br>" +
            "(A) '表面' 意味着材料的最终涂层或表面处理。" +
            "<br><br>" +
            "(B) '涂层' 意味着覆盖在表面上的一层物质。" +
            "<br><br>" +
            "(C) '层' 意味着覆盖表面或主体的多层材料中的一层。"
    }
];

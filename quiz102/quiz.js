...
var questions = [
    ...
    },
    {
        ...
        answers: [
            ...
            { option: "D", answer: "reverse", chinese_answer: "逆转", chinese_romanization: "nìzhuǎn" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'reverse' means to cause to move backward or to change to the opposite state." +
            "<br><br>" +
            "(A) 'enhance' means to improve the quality, amount, or strength of something." +
            "<br><br>" +
            "(B) 'exacerbate' means to make a problem, bad situation, or negative feeling worse." +
            "<br><br>" +
            "(C) 'dismiss' means to order or allow to leave; send away.",
        chinese_explanation: "(D) '逆转' 意味着使向后移动或改变到相反的状态。" +
            "<br><br>" +
            "(A) '增强' 意味着提高某物的质量、数量或强度。" +
            "<br><br>" +
            "(B) '加剧' 意味着使问题、糟糕的情况或负面情绪恶化。" +
            "<br><br>" +
            "(C) '驳回' 意味着命令或允许离开；送走。"
    },
    {
   ...
   question: "The mother would __________ her son, making sure he always had his favorite meals and never missed a bedtime story.",
    ...
    },
    {
        ...
        answers: [
            ...
            { option: "C", answer: "demeaned", chinese_answer: "贬低", chinese_romanization: "biǎndī" },
            { option: "D", answer: "encouraged", chinese_answer: "鼓励", chinese_romanization: "gǔlì" }
        ],
        correctAnswer: "C",
        explanation: "(C) 'demeaned' means to cause a severe loss in the dignity of and respect for (someone or something)." +
            "<br><br>" +
    ...
    },
    {
        ...
        answers: [
            ...
            { option: "C", answer: "neglecting", chinese_answer: "忽略", chinese_romanization: "hūlüè" },
        ...
        explanation: "(D) 'disparaging' figuratively means to regard or represent as being of little worth." +
            ...
            "<br><br>" +
            "(C) 'neglecting' means to fail to care for properly.",

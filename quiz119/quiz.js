...
var questions = [
    ...
    answers: [
        ...
        { option: "B", answer: "created", chinese_answer: "创造", chinese_romanization: "chuàngzào" },
        { option: "C", answer: "enhanced", chinese_answer: "增强", chinese_romanization: "zēngqiáng" },
        { option: "D", answer: "spoiled", chinese_answer: "破坏", chinese_romanization: "pòhuài" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'spoiled' means to diminish or destroy the value or quality of something." +
        "<br><br>" +
        "(A) 'fixed' means to repair or mend something." +
        "<br><br>" +
        "(B) 'created' means to bring something into existence." +
        "<br><br>" +
    ...
    {
        id: 5,
        question: "The rules that __________ to the competition were explained clearly to all participants, ensuring everyone understood the guidelines.",
        chinese_question: "与比赛相关的规则已向所有参与者清楚解释，确保每个人都了解指南。",
        answers: [
    ...
    {
        id: 9,
    question: "The artist decided to __________ her name on her latest sculpture by engraving it carefully on the base.",
    chinese_question: "艺术家决定在她最新的雕塑上通过仔细刻在底座上来 __________ 她的名字。",
    answers: [
        ...
        { option: "C", answer: "inscribe", chinese_answer: "铭刻", chinese_romanization: "míngkè" },
        { option: "D", answer: "deface", chinese_answer: "损坏", chinese_romanization: "sǔnhuài" }
    ],
    correctAnswer: "C",
    explanation: "(C) 'inscribe' means to write or carve words or symbols on something, especially as a formal or permanent record." +
        "<br><br>" +
        "(A) 'support' means to give assistance to." +
        "<br><br>" +
        "(B) 'assist' means to help someone." +
        "<br><br>" +
        "(D) 'deface' means to spoil the surface or appearance of something by drawing or writing on it.",
    chinese_explanation: "(C) '铭刻' 意味着在某物上写或刻字或符号，特别是作为正式或永久记录。" +
        "<br><br>" +
        "(A) '支持' 意味着给予帮助。" +
        "<br><br>" +
        "(B) '帮助' 意味着帮助某人。" +
        "<br><br>" +
        "(D) '损坏' 意味着通过绘画或书写破坏某物的表面或外观。"
    },
    {
        id: 10,
        question: "The skilled interviewer was able to __________ insightful responses from the guests by asking thought-provoking questions.",
        chinese_question: "熟练的采访者通过提出发人深省的问题来 __________ 嘉宾的深刻回应。",
        answers: [
            { option: "A", answer: "elicit", chinese_answer: "引出", chinese_romanization: "yǐnchū" },
            { option: "B", answer: "suppress", chinese_answer: "抑制", chinese_romanization: "yìzhì" },
            { option: "C", answer: "obscure", chinese_answer: "使模糊", chinese_romanization: "shǐ móhú" },
            { option: "D", answer: "complicate", chinese_answer: "使复杂", chinese_romanization: "shǐ fùzá" }
        ],
        correctAnswer: "A",
        explanation: "(A) 'elicit' means to draw out a response, answer, or fact from someone." +
            "<br><br>" +
            "(B) 'suppress' means to forcibly put an end to something." +
            "<br><br>" +
            "(C) 'obscure' means to make something difficult to understand." +
            "<br><br>" +
            "(D) 'complicate' means to make something more difficult or confusing by adding extra elements.",
        chinese_explanation: "(A) '引出' 意味着从某人那里引出回应、答案或事实。" +
            "<br><br>" +
            "(B) '抑制' 意味着强制结束某事。" +
            "<br><br>" +
            "(C) '使模糊' 意味着使某事难以理解。" +

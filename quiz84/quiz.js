...
var questions = [
    ...
    {
        id: 3,
    question: "They decided it was time to __________ the topic of budget cuts in the next meeting.",
    chinese_question: "他们决定在下次会议上 __________ 预算削减的话题。",
    answers: [
    ...
    {
        id: 4,
    question: "The teacher __________ the students to study hard for the upcoming exams.",
    chinese_question: "老师 __________ 学生们努力学习以应对即将到来的考试。",
    answers: [
    ...
    {
        id: 5,
    question: "The repetitive noise from the neighbor's house started to __________ on their nerves.",
    chinese_question: "邻居家的重复噪音开始 __________ 他们的神经。",
    answers: [
    ...
    {
        id: 7,
    question: "To __________ the approval process, the company implemented an online application system.",
    chinese_question: "为了 __________ 审批流程，公司实施了在线申请系统。",
    answers: [
    ...
    {
        id: 8,
    question: "The children began to __________ excitedly about their upcoming trip to the zoo.",
    chinese_question: "孩子们开始兴奋地 __________ 他们即将到来的动物园之行。",
    answers: [
    ...
    {
        id: 10,
        question: "The quiet time in the morning gave her a chance to __________ on her recent experiences.",
        chinese_question: "早晨的安静时间让她有机会 __________ 最近的经历。",
        answers: [

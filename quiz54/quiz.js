...
var questions = [
    ...
    {
        id: 2,
    question: "His ideas were so out of the ordinary, they might as well be from another __________.",
    chinese_question: "他的想法如此不同寻常，就像来自另一个 __________。",
    answers: [
        { option: "A", answer: "planet", chinese_answer: "行星", chinese_romanization: "xíngxīng" },
        { option: "B", answer: "star", chinese_answer: "恒星", chinese_romanization: "héngxīng" },
        { option: "C", answer: "galaxy", chinese_answer: "星系", chinese_romanization: "xīngxì" },
        { option: "D", answer: "moon", chinese_answer: "月亮", chinese_romanization: "yuèliàng" }
    ],
    correctAnswer: "A",
    explanation: "(A) 'planet' means something or someone that is very different or unusual." +
        "<br><br>" +
        "(B) 'star' means a fixed luminous point in the night sky that is a large, remote incandescent body like the sun." +
        "<br><br>" +
        "(C) 'galaxy' means a system of millions or billions of stars, together with gas and dust, held together by gravitational attraction." +
        "<br><br>" +
        "(D) 'moon' means a natural satellite of a planet.",
    chinese_explanation: "(A) '行星' 意味着非常不同或不寻常的事物或人。" +
        "<br><br>" +
        "(B) '恒星' 意味着夜空中固定的发光点，是像太阳一样的大而遥远的炽热体。" +
        "<br><br>" +
        "(C) '星系' 意味着由引力吸引在一起的数百万或数十亿颗恒星以及气体和尘埃组成的系统。" +
        "<br><br>" +
        "(D) '月亮' 意味着行星的天然卫星。"
    },
    {
    ...
    },
    {
        ...
        answers: [
            ...
            { option: "B", answer: "brute force", chinese_answer: "蛮力", chinese_romanization: "mánlì" },
        ...
        explanation: "(C) 'finesse' means intricate and refined delicacy; skillful handling of a situation." +
            ...
            "<br><br>" +
            "(B) 'brute force' means strong and forceful, without any finesse." +
            "<br><br>" +

...
var questions = [
    ...
    {
        id: 3,
    question: "The salesman tried to __________ the customers into buying the defective product by making false claims about its quality.",
    chinese_question: "推销员试图通过虚假的质量声明来 __________ 顾客购买有缺陷的产品。",
    answers: [
    ...
    {
        id: 5,
    question: "Based on the recent findings, the data clearly __________ that more research is needed in this area.",
    chinese_question: "根据最近的发现，数据清楚地 __________ 需要在这一领域进行更多研究。",
    answers: [
    ...
    {
        id: 8,
    question: "The scam artist managed to __________ several people into giving him their personal information by pretending to be a bank official.",
    chinese_question: "诈骗犯通过假装是银行官员设法 __________ 几个人，让他们把个人信息告诉他。",
    answers: [
    ...
    answers: [
        ...
        { option: "D", answer: "indulge", chinese_answer: "纵容", chinese_romanization: "zòngróng" }
    ],
    correctAnswer: "C",

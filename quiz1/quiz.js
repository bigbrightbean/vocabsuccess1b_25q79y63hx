...
var questions = [
    ...
    },
    {
        ...
        explanation: "(A) 'synonymous' means having the same or nearly the same meaning as another word or phrase." +
            "<br><br>" +
            "(B) 'unfamiliar' means not known or recognized." +
            "<br><br>" +
            "(C) 'obscure' means not discovered or known about; uncertain." +
            "<br><br>" +
            "(D) 'anonymous' means (of a person) not identified by name; of unknown name.",
    ...
    {
        id: 10,
        question: "After careful analysis, the scientists concluded that it was __________ to develop a vaccine within a year.",
        chinese_question: "经过仔细分析，科学家们得出结论，在一年内开发出疫苗是 __________ 的。",
        answers: [

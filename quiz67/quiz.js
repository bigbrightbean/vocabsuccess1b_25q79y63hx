...
var questions = [
    {
        ...
        answers: [
            { option: "A", answer: "adventure", chinese_answer: "冒险", chinese_romanization: "màoxiǎn" },
            ...
            { option: "D", answer: "excursion", chinese_answer: "远足", chinese_romanization: "yuǎnzú" }
        ],
        correctAnswer: "C",
        explanation: "(C) 'escapade' means an act or incident involving excitement, daring, or adventure." +
            "<br><br>" +
            "(A) 'adventure' means an unusual and exciting, typically hazardous, experience or activity." +
            "<br><br>" +
            "(B) 'retreat' means a quiet or secluded place in which one can rest and relax." +
            "<br><br>" +
            "(D) 'excursion' means a short journey or trip, especially one engaged in as a leisure activity.",
        chinese_explanation: "(C) '冒险行为'一词意味着涉及兴奋、大胆或冒险的行为或事件。" +
            "<br><br>" +
            "(A) '冒险' 意味着一种不同寻常和令人兴奋的，通常是危险的经历或活动。" +
            "<br><br>" +
            "(B) '撤退' 意味着一个可以休息和放松的安静或隐蔽的地方。" +
            "<br><br>" +
            "(D) '远足' 意味着短途旅行或郊游，特别是作为一种休闲活动。"
    },
    {
        id: 2,

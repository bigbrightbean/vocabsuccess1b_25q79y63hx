...
var questions = [
    {
        id: 1,
        question: "The company's new policy required them to __________ some of their employees to overseas offices, which created a mix of excitement and anxiety among the staff.",
        chinese_question: "公司的新政策要求他们将一些员工 __________ 到海外办公室，这在员工中引起了兴奋和焦虑的混合反应。",
        answers: [
                { option: "A", answer: "hire", chinese_answer: "雇佣", chinese_romanization: "gùyōng" },
                { option: "B", answer: "promote", chinese_answer: "提升", chinese_romanization: "tíshēng" },
                { option: "C", answer: "train", chinese_answer: "培训", chinese_romanization: "pèixùn" },
                { option: "D", answer: "expatriate", chinese_answer: "派驻国外", chinese_romanization: "pàizhù guówài" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'expatriate' means to send someone to live or work in a foreign country." +
            "<br><br>" +
            "(A) 'hire' means to employ someone for wages." +
            "<br><br>" +
            "(B) 'promote' means to advance someone in rank or position." +
            "<br><br>" +
            "(C) 'train' means to teach someone a particular skill or type of behavior.",
        chinese_explanation: "(D) '派驻国外' 意味着派遣某人到国外生活或工作。" +
            "<br><br>" +
            "(A) '雇佣' 意味着以工资雇佣某人。" +
            "<br><br>" +
            "(B) '提升' 意味着在职级或职位上提升某人。" +
            "<br><br>" +
            "(C) '培训' 意味着教授某人某种特定技能或行为。"
    },
    {
        id: 2,
    ...
    answers: [
        ...
        { option: "C", answer: "appreciating", chinese_answer: "欣赏", chinese_romanization: "xīnshǎng" },
        { option: "D", answer: "misinterpreting", chinese_answer: "误解", chinese_romanization: "wùjiě" }
    ],
    correctAnswer: "B",
    explanation: "(B) 'regurgitating' means to repeat information without understanding it." +
        "<br><br>" +
        "(A) 'understanding' means to grasp the meaning of something." +
        "<br><br>" +
        "(C) 'appreciating' means to recognize the full worth of." +
        "<br><br>" +
        "(D) 'misinterpreting' means to understand something incorrectly.",
    ...
    answers: [
        ...
        { option: "B", answer: "summarize", chinese_answer: "总结", chinese_romanization: "zǒngjié" },
        { option: "C", answer: "belabor", chinese_answer: "反复强调", chinese_romanization: "fǎnfù qiángdiào" },
        { option: "D", answer: "downplay", chinese_answer: "轻视", chinese_romanization: "qīngshì" }
    ],
    correctAnswer: "C",
    explanation: "(C) 'belabor' means to argue or elaborate on a subject excessively." +
        "<br><br>" + 
        "(A) 'simplify' means to make something simpler or easier to do or understand." +
        "<br><br>" + 
        "(B) 'summarize' means to give a brief statement of the main points." +
        "<br><br>" + 
        "(D) 'downplay' means to make something seem less important or significant.",
    chinese_explanation: "(C) '反复强调' 意味着过度地争论或阐述某个主题。" +
        "<br><br>" + 
        "(A) '简化' 意味着使某事更简单或更容易做或理解。" +
        "<br><br>" + 
        "(B) '总结' 意味着对主要观点进行简要说明。" +
        "<br><br>" + 
        "(D) '轻视' 意味着让某事看起来不那么重要或显著。"
    },
    {
        id: 9,
        question: "To ensure the building's safety, engineers decided to __________ the foundation by adding extra support and materials.",
        chinese_question: "为了确保建筑的安全，工程师们决定通过增加额外的支撑和材料来 __________ 地基。",
        answers: [

...
var questions = [
    {
        id: 1,
        question: "Before starting the experiment, the scientist had to __________ the scales and adjust them to get precise results.",
        chinese_question: "在开始实验之前，科学家必须 __________ 秤并调整它们以获得精确的结果。",
        answers: [
    ...
    answers: [
        ...
        { option: "C", answer: "aggrieve", chinese_answer: "使痛苦", chinese_romanization: "shǐ tòngkǔ" },
        { option: "D", answer: "delight", chinese_answer: "使高兴", chinese_romanization: "shǐ gāoxìng" }
    ],
    correctAnswer: "C",
    explanation: "(C) 'aggrieve' means to cause distress or affliction." +
        "<br><br>" +
        "(A) 'comfort' means to soothe or console." +
        "<br><br>" +
        "(B) 'beguile' means to charm or enchant, often in a deceptive way." +
        "<br><br>" +
        "(D) 'delight' means to please greatly.",
    chinese_explanation: "(C) '使痛苦' 意味着引起痛苦或苦难。" +
        "<br><br>" +
        "(A) '安慰' 意味着抚慰或安慰。" +
        "<br><br>" +
        "(B) '欺骗' 意味着用有时是欺骗的方式去吸引或迷住。" +
        "<br><br>" +
        "(D) '使高兴' 意味着使人非常愉快。"
    },
    {
    ...
    },
    {
        ...
        answers: [
            ...
            { option: "B", answer: "confronted", chinese_answer: "对抗", chinese_romanization: "duìkàng" },
            { option: "C", answer: "dodged", chinese_answer: "闪避", chinese_romanization: "shǎnbì" },
            { option: "D", answer: "tackled", chinese_answer: "处理", chinese_romanization: "chǔlǐ" }
        ],
        correctAnswer: "C",
        explanation: "(C) 'dodged' means to move quickly to avoid someone or something." +
            "<br><br>" +
            "(A) 'faced' means to confront and deal with or accept." +
            "<br><br>" +
            "(B) 'confronted' means to face up to and deal with (a problem or difficult situation)." +
            "<br><br>" +
            "(D) 'tackled' means to make determined efforts to deal with (a problem or difficult task).",
        chinese_explanation: "(C) '闪避' 一词意味着迅速移动以避开某人或某物。" +
            "<br><br>" +
            "(A) '面对' 意味着面对和处理或接受。" +
            "<br><br>" +
    ...
    },
    {
        ...
        answers: [
            ...
            { option: "B", answer: "separated", chinese_answer: "分离", chinese_romanization: "fēnlí" },
            { option: "C", answer: "simplified", chinese_answer: "简化", chinese_romanization: "jiǎnhuà" },
            { option: "D", answer: "aggregated", chinese_answer: "汇总", chinese_romanization: "huìzǒng" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'aggregated' means to collect and combine (several separate elements) into a whole." +
            "<br><br>" +
            "(A) 'ignored' means to refuse to take notice of or acknowledge." +
            "<br><br>" +
            "(B) 'separated' means to cause to move or be apart." +
            "<br><br>" +
            "(C) 'simplified' means to make (something) simpler or easier to do or understand.",
        chinese_explanation: "(D) '汇总' 意味着收集和组合（几个独立元素）成一个整体。" +
            "<br><br>" +
            "(A) '忽视' 意味着拒绝注意或承认。" +
            "<br><br>" +
            "(B) '分离' 意味着使移动或分开。" +
    ...
    {
        id: 9,
        question: "Instead of offering constructive feedback, he chose to __________ his colleague's suggestions by mocking them openly.",
        chinese_question: "他没有提供建设性的反馈，而是选择通过公开嘲笑 __________ 同事的建议。",
        answers: [
            ...
            { option: "D", answer: "deride", chinese_answer: "嘲笑", chinese_romanization: "cháoxiào" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'deride' means to express contempt for; ridicule." +
            "<br><br>" +
            "(A) 'value' means to consider something to be important or beneficial." +
            "<br><br>" +
            "(B) 'consider' means to think carefully about something." +
            "<br><br>" +
            "(C) 'accept' means to consent to receive or undertake something.",
        chinese_explanation: "(D) '嘲笑' 意味着表达蔑视；嘲弄。" +
            "<br><br>" +
            "(A) '重视' 意味着认为某事重要或有益。" +
            "<br><br>" +
            "(B) '考虑' 意味着仔细考虑某事。" +
    ...
    {
        id: 10,
    question: "The chef worked tirelessly to __________ the recipe for the perfect souffle and achieve the ideal texture.",
    chinese_question: "这位厨师不知疲倦地工作，终于 __________ 了制作完美蛋奶酥的食谱，并达到了理想的质地。",
    answers: [

...
var questions = [
    ...
    {
        id: 3,
        question: "The new manager's approach was to __________ employees by helping them grow and improve their skills through constructive feedback.",
        chinese_question: "新经理的做法是通过帮助员工成长和提高技能来 __________ 他们，并提供建设性的反馈。",
        answers: [
            { option: "A", answer: "criticize", chinese_answer: "批评", chinese_romanization: "pīpíng" },
            { option: "B", answer: "denigrate", chinese_answer: "诋毁", chinese_romanization: "dǐhuǐ" },
            { option: "C", answer: "berate", chinese_answer: "斥责", chinese_romanization: "chìzé" },
            { option: "D", answer: "edify", chinese_answer: "启发", chinese_romanization: "qǐfā" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'edify' means to instruct or improve someone morally or intellectually." +
            "<br><br>" +
            "(A) 'criticize' means to indicate the faults of someone or something in a disapproving way." +
            "<br><br>" +
            "(B) 'denigrate' means to criticize unfairly; disparage." +
            "<br><br>" +
            "(C) 'berate' means to scold or criticize someone angrily.",
        chinese_explanation: "(D) '启发' 意味着在道德或智力上指导或改善某人。" +
            "<br><br>" +
    ...
    {
        id: 8,
        question: "The professor was known to __________ complex theories by breaking them down into simpler concepts that students could easily understand.",
        chinese_question: "教授以将复杂的理论分解成学生易于理解的简单概念来 __________ 而闻名。",
        answers: [
            { option: "A", answer: "confound", chinese_answer: "使困惑", chinese_romanization: "shǐ kùnhuò" },
            { option: "B", answer: "obscure", chinese_answer: "使模糊", chinese_romanization: "shǐ móhú" },
            { option: "C", answer: "elucidate", chinese_answer: "阐明", chinese_romanization: "chǎnmíng" },
            { option: "D", answer: "complicate", chinese_answer: "使复杂", chinese_romanization: "shǐ fùzá" }
        ],
        correctAnswer: "C",
        explanation: "(C) 'elucidate' means to make something clear; explain." +
            "<br><br>" +
            "(A) 'confound' means to cause surprise or confusion in someone." +
            "<br><br>" +
            "(B) 'obscure' means to make something difficult to understand." +
            "<br><br>" +
            "(D) 'complicate' means to make something more difficult or confusing by adding extra elements.",
        chinese_explanation: "(C) '阐明' 意味着使某事清楚；解释。" +
            "<br><br>" +
            "(A) '使困惑' 意味着使某人惊讶或困惑。" +
            "<br><br>" +
            "(B) '使模糊' 意味着使某事难以理解。" +
            "<br><br>" +
            "(D) '使复杂' 意味着通过添加额外元素使某事更加困难或混乱。"
    },
    {
        id: 9,
    question: "The teacher did not hesitate to __________ the student for cheating on the exam by reprimanding him severely in front of the class.",
    chinese_question: "老师毫不犹豫地通过在全班面前严厉斥责 __________ 学生考试作弊。",
    answers: [
        ...
        { option: "C", answer: "castigate", chinese_answer: "严厉批评", chinese_romanization: "yánlì pīpíng" },
        { option: "D", answer: "commend", chinese_answer: "表扬", chinese_romanization: "biǎoyáng" }
    ],
    correctAnswer: "C",
    explanation: "(C) 'castigate' means to reprimand someone severely." +
        "<br><br>" + 
    ...
    chinese_explanation: "(C) '严厉批评' 意味着严厉地斥责某人。" +
        "<br><br>" + 
        "(A) '赞扬' 意味着表达热烈的赞同或钦佩。" +
        "<br><br>" + 
        "(B) '帮助' 意味着帮助或支持。" +
    ...
    {
        id: 10,
        question: "The student attempted to __________ the strict rules of the exam by cheating and using unauthorized notes.",
        chinese_question: "学生试图通过作弊和使用未经授权的笔记来 __________ 考试的严格规定。",
        answers: [

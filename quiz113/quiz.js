...
var questions = [
    {
        id: 1,
        question: "He decided to __________ the case to ensure that justice was served.",
        chinese_question: "他决定 __________ 案件，以确保正义得到伸张。",
        answers: [
    ...
    {
        id: 3,
        question: "The calm lake __________ the beautiful mountain scenery perfectly.",
        chinese_question: "平静的湖面完美地 __________ 出美丽的山景。",
        answers: [

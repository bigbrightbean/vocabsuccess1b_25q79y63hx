...
var questions = [
    ...
    {
        id: 3,
        question: "The new employee was __________ about starting his first project and eager to prove his skills.",
        chinese_question: "新员工对开始他的第一个项目感到非常__________，并急于展示他的技能。",
        answers: [
    ...
    {
        id: 5,
    question: "It is __________ to remain silent when someone else is speaking during a meeting, because it shows respect and allows everyone to be heard.",
    chinese_question: "在会议中当别人讲话时保持沉默是__________的，因为这表现出尊重，并让每个人都有机会发言。",
    answers: [
        ...
        { option: "C", answer: "disrespectful", chinese_answer: "不尊重的", chinese_romanization: "bù zūnzhòng de" },

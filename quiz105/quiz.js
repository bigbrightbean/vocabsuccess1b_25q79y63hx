...
var questions = [
    {
        ...
        answers: [
            ...
            { option: "B", answer: "befriended", chinese_answer: "结交", chinese_romanization: "jiéjiāo" },
            { option: "C", answer: "abducted", chinese_answer: "绑架", chinese_romanization: "bǎngjià" },
            { option: "D", answer: "rescued", chinese_answer: "营救", chinese_romanization: "yíngjiù" }
        ],
        correctAnswer: "C",
        explanation: "(C) 'abducted' means taken away illegally by force or deception; kidnapped." +
            "<br><br>" +
            "(A) 'protected' means kept safe from harm or injury." +
            "<br><br>" +
            "(B) 'befriended' means acted as a friend to (someone) by offering help or support." +
            "<br><br>" +
            "(D) 'rescued' means saved (someone) from a dangerous or distressing situation.",
        chinese_explanation: "(C) '绑架' 一词意味着被非法强行或欺骗地带走；绑架。" +
            "<br><br>" +
            "(A) '保护' 意味着使免受伤害或伤害。" +
            "<br><br>" +
            "(B) '结交' 意味着通过提供帮助或支持作为朋友对待（某人）。" +
            "<br><br>" +
            "(D) '营救' 意味着从危险或困境中拯救（某人）。"
    },
    {
        id: 2,
    ...
    {
        id: 4,
        question: "To gain entry into the high-profile gala, she had to __________ as a renowned actress, though she was merely an aspiring performer.",
        chinese_question: "为了进入这个备受瞩目的晚会，她不得不 __________ 为一名著名演员，尽管她只是一个有抱负的表演者。",
        answers: [
            { option: "A", answer: "expose", chinese_answer: "揭露", chinese_romanization: "jiēlù" },
            { option: "B", answer: "unveil", chinese_answer: "揭示", chinese_romanization: "jiēshì" },
            { option: "C", answer: "reveal", chinese_answer: "透露", chinese_romanization: "tòulù" },
        ...
        explanation: "(D) 'masquerade' means to pretend to be someone one is not." +
            "<br><br>" +
            "(A) 'expose' means to make something visible by uncovering it." +
            "<br><br>" +
            "(B) 'unveil' means to remove a covering from something." +
            "<br><br>" +
    ...
    },
    {
        ...
        answers: [
            ...
            { option: "D", answer: "fleece", chinese_answer: "欺诈", chinese_romanization: "qīzhà" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'fleece' means to deceive or swindle someone out of money." +
            "<br><br>" + 
            "(A) 'assist' means to help someone." +
            "<br><br>" + 
            "(B) 'praise' means to express warm approval or admiration." +
            "<br><br>" + 
            "(C) 'aid' means to provide help or support.",
        chinese_explanation: "(D) '欺诈' 意味着骗取或诈骗某人钱财。" +
            "<br><br>" + 
            "(A) '帮助' 意味着帮助某人。" +
            "<br><br>" + 
            "(B) '赞扬' 意味着表达热烈的赞同或钦佩。" +

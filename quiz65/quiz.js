...
var questions = [
    ...
    {
        id: 4,
        question: "In __________ to her grandmother's wishes of wanting her to have a stable career, she decided to pursue a career in medicine instead of music.",
        chinese_question: "出于对祖母希望她拥有稳定职业的 __________ ，她决定追求医学事业而不是音乐。",
        answers: [
    ...
    {
        id: 5,
        question: "The hero of the story is the __________ of courage and selflessness, as he demonstrated these qualities through his actions.",
        chinese_question: "故事中的英雄是勇气和无私的 __________ ，因为他通过自己的行动展现了这些品质。",
        answers: [
    ...
    {
        id: 6,
    question: "The surgeon skillfully reattached the patient's severed __________ after the accident, focusing on the complex task of reconnecting bones, blood vessels, and nerves of the arm.",
    chinese_question: "事故后，外科医生熟练地重新接上了患者断掉的 __________ ，专注于重新连接手臂的骨骼、血管和神经的复杂任务。",
    answers: [
    ...
    answers: [
        ...
        { option: "B", answer: "paradigm", chinese_answer: "范例", chinese_romanization: "fànlì" },
    ...
    explanation: "(A) 'portion' means a part of a whole." +
        "<br><br>" +
        "(B) 'paradigm' means a typical example or pattern of something; a model." +
        "<br><br>" +

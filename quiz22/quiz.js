...
var questions = [
    ...
    },
    {
        ...
        correctAnswer: "B",
        explanation: "(B) 'uncanny' means very strange and difficult to explain." +
            "<br><br>" +
            "(A) 'mundane' means ordinary and not interesting." +
            "<br><br>" +
            "(C) 'familiar' means well known because it has been seen or experienced often." +
            "<br><br>" +
            "(D) 'banal' means very common and boring.",
        chinese_explanation: "(B) '神秘的' 意味着非常奇怪且难以解释。" +
            "<br><br>" +
            "(A) '平凡的' 意味着普通而不有趣。" +
            "<br><br>" +
            "(C) '熟悉的' 意味着因经常看到或经历而熟知的。" +
            "<br><br>" +
            "(D) '陈腐的' 意味着非常普遍且无聊的。"
    },
    {

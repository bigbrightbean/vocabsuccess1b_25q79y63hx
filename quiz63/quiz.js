...
var questions = [
    ...
    },
    {
        ...
        answers: [
            ...
            { option: "B", answer: "observatory", chinese_answer: "天文台", chinese_romanization: "tiānwéntái" },
            { option: "C", answer: "catacomb", chinese_answer: "地下墓穴", chinese_romanization: "dìxià mùxué" },
            { option: "D", answer: "armory", chinese_answer: "军械库", chinese_romanization: "jūnxièkù" }
        ],
        correctAnswer: "A",
        explanation: "(A) 'asylum' means an institution offering shelter and support to people who are mentally ill." +
            "<br><br>" +
            "(B) 'observatory' means a room or building housing an astronomical telescope or other scientific equipment for the study of natural phenomena." +
            "<br><br>" +
            "(C) 'catacomb' means an underground cemetery consisting of a subterranean gallery with recesses for tombs." +
            "<br><br>" +
            "(D) 'armory' means a place where weapons are kept."
        chinese_explanation: "(A) '收容所' 意味着为精神病患者提供庇护和支持的机构。" +
            "<br><br>" +
            "(B) '天文台' 意味着容纳天文望远镜或其他科学设备以研究自然现象的房间或建筑。" +
            "<br><br>" +
            "(C) '地下墓穴' 意味着由地下画廊组成的地下墓地，内有墓穴。" +
            "<br><br>" +
            "(D) '军械库' 意味着存放武器的地方。"
    }
];

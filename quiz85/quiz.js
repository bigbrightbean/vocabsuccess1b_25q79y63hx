...
var questions = [
    {
        id: 1,
    question: "Her enthusiasm for the project never __________ even during the toughest times, but remained strong and unwavering like a steady flame in the dark.",
    chinese_question: "即使在最艰难的时期，她对项目的热情也从未 __________，而是像黑暗中的稳定火焰一样保持着坚定不移。",
    answers: [
        { option: "A", answer: "flourished", chinese_answer: "繁荣", chinese_romanization: "fánróng" },
        { option: "B", answer: "intensified", chinese_answer: "加强", chinese_romanization: "jiāqiáng" },
    ...
    explanation: "(D) 'faded' means to gradually grow faint and disappear." +
        ...
        "<br><br>" +
        "(C) 'brightened' means to make or become lighter or more cheerful.",

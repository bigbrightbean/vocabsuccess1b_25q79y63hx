...
var questions = [
    ...
    {
        id: 10,
    question: "The politician's reputation was __________ after the scandal was made public.",
    chinese_question: "丑闻被公开后，这位政治家的声誉被 __________ 了。",
    answers: [
        { option: "A", answer: "enhanced", chinese_answer: "提高", chinese_romanization: "tígāo" },
        { option: "B", answer: "ignored", chinese_answer: "忽视", chinese_romanization: "hūshì" },
        { option: "C", answer: "sullied", chinese_answer: "玷污", chinese_romanization: "diànwū" },
        { option: "D", answer: "improved", chinese_answer: "改善", chinese_romanization: "gǎishàn" }
    ],
    correctAnswer: "C",
    explanation: "(C) 'sullied' means to damage the purity or integrity of; defile." +
        "<br><br>" +
        "(A) 'enhanced' means to intensify or increase in quality, value, or extent." +
        "<br><br>" +
        "(B) 'ignored' means to refuse to take notice of." +
        "<br><br>" +
        "(D) 'improved' means to make or become better.",
    chinese_explanation: "(C) '玷污' 意味着损害纯洁性或完整性；玷污。" +
        "<br><br>" +
        "(A) '提高' 意味着加强或增加质量、价值或程度。" +
        "<br><br>" +
        "(B) '忽视' 意味着拒绝注意。" +
        "<br><br>" +
        "(D) '改善' 意味着使更好或变得更好。"

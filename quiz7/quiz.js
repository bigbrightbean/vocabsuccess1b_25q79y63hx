...
var questions = [
    ...
    {
        id: 9,
    question: "Her __________ nature often led people to trust her easily, as she was always straightforward and honest.",
    chinese_question: "她的 __________ 性格经常让人们很容易信任她，因为她总是直率而诚实。",
    answers: [
        { option: "A", answer: "deceptive", chinese_answer: "欺骗的", chinese_romanization: "qīpiàn de" },
        { option: "B", answer: "cunning", chinese_answer: "狡猾的", chinese_romanization: "jiǎohuá de" },
        { option: "C", answer: "manipulative", chinese_answer: "操纵的", chinese_romanization: "cāozòng de" },
        { option: "D", answer: "ingenuous", chinese_answer: "天真的", chinese_romanization: "tiānzhēn de" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'ingenuous' means innocent and unsuspecting." +
        "<br><br>" +
        "(A) 'deceptive' means giving an appearance or impression different from the true one; misleading." +
        "<br><br>" +
        "(B) 'cunning' means having or showing skill in achieving one's ends by deceit or evasion." +
        "<br><br>" +
        "(C) 'manipulative' means characterized by unscrupulous control of a situation or person.",
    chinese_explanation: "(D) '天真的' 意味着天真和毫不怀疑的。" +
        "<br><br>" +
        "(A) '欺骗的' 意味着表现或印象与真实情况不同；误导。" +
        "<br><br>" +
        "(B) '狡猾的' 意味着在实现个人目标时表现出欺骗或逃避的技巧。" +
        "<br><br>" +
        "(C) '操纵的' 意味着对情况或个人进行不择手段的控制。"
    },
    {
        id: 10,
        question: "Although the comment seemed __________, it actually contained a subtle insult that questioned her intelligence and work ethic.",
        chinese_question: "虽然这句话看似__________，但实际上含有微妙的侮辱，质疑了她的智力和工作态度。",
        answers: [
            { option: "A", answer: "harmful", chinese_answer: "有害的", chinese_romanization: "yǒuhài de" },
            { option: "B", answer: "dangerous", chinese_answer: "危险的", chinese_romanization: "wēixiǎn de" },
            { option: "C", answer: "innocuous", chinese_answer: "无害的", chinese_romanization: "wúhài de" },
            { option: "D", answer: "malicious", chinese_answer: "恶意的", chinese_romanization: "èyì de" }
        ],
        correctAnswer: "C",
        explanation: "(C) 'innocuous' means not harmful or offensive." +
            "<br><br>" +
            "(A) 'harmful' means causing or likely to cause harm." +
            "<br><br>" +
            "(B) 'dangerous' means able or likely to cause harm or injury." +
            "<br><br>" +
            "(D) 'malicious' means characterized by malice; intending or intended to do harm.",
        chinese_explanation: "(C) '无害的' 意味着无害或无冒犯。" +
            "<br><br>" +
            "(A) '有害的' 意味着造成或可能造成伤害。" +
            "<br><br>" +
            "(B) '危险的' 意味着能够或可能造成伤害或损伤。" +
            "<br><br>" +
            "(D) '恶意的' 意味着具有恶意；意图或故意造成伤害。"
    }
];

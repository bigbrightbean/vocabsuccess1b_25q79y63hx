...
var questions = [
    ...
    {
        id: 2,
    question: "The journalist worked hard to __________ the myths surrounding the celebrity's personal life.",
    chinese_question: "记者努力 __________ 围绕这位名人个人生活的神话。",
    answers: [
    ...
    explanation: "(B) 'debunk' means to expose the falseness or hollowness of a myth, idea, or belief." +
        ...
        "<br><br>" + 
        "(C) 'support' means to bear all or part of the weight of something; hold up." +
        "<br><br>" + 
    ...
    answers: [
        ...
        { option: "B", answer: "claim", chinese_answer: "声称", chinese_romanization: "shēngchēng" },
        { option: "C", answer: "ignore", chinese_answer: "忽视", chinese_romanization: "hūshì" },
        { option: "D", answer: "secure", chinese_answer: "保障", chinese_romanization: "bǎozhàng" }
    ],
    correctAnswer: "A",
    explanation: "(A) 'cede' means to give up power or territory." +
        "<br><br>" + 
        "(B) 'claim' means to state that something is the case, typically without providing evidence or proof." +
        "<br><br>" + 
        "(C) 'ignore' means to refuse to take notice of or acknowledge." +
        "<br><br>" + 
        "(D) 'secure' means to fix or attach something firmly so that it cannot be moved or lost.",
    chinese_explanation: "(A) '放弃' 意味着放弃权力或领土。" +
        "<br><br>" + 
        "(B) '声称' 意味着陈述某事是事实，通常不提供证据或证明。" +
        "<br><br>" + 
        "(C) '忽视' 意味着拒绝注意或承认。" +
        "<br><br>" + 
        "(D) '保障' 意味着牢固地固定或附着某物，以使其不能移动或丢失。"
    },
    {
        id: 4,
    ...
    {
        id: 5,
    question: "The unexpected news of the lottery win completely __________ her.",
    chinese_question: "突然的彩票中奖消息让她完全 __________。",
    answers: [
    ...
    explanation: "(B) 'flabbergasted' means to shock or surprise someone greatly." +
        "<br><br>" + 
        "(A) 'calmed' means to make someone or something peaceful or quiet." +
        "<br><br>" + 
    ...
    answers: [
        ...
        { option: "B", answer: "push", chinese_answer: "推", chinese_romanization: "tuī" },
        { option: "C", answer: "ignore", chinese_answer: "忽视", chinese_romanization: "hūshì" },
    ...
    explanation: "(A) 'dissuade' means to persuade someone not to take a particular course of action, used figuratively here." +
        "<br><br>" + 
        "(B) 'push' means to exert force on someone or something in order to move them away from oneself." +
        "<br><br>" + 
        "(C) 'ignore' means to refuse to take notice of or acknowledge." +
        "<br><br>" + 
    ...
    answers: [
        ...
        { option: "C", answer: "avoided", chinese_answer: "避开", chinese_romanization: "bìkāi" },

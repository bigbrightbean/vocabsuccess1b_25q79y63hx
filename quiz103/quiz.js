...
var questions = [
    ...
    },
    {
        ...
        answers: [
            { option: "A", answer: "demean", chinese_answer: "贬低", chinese_romanization: "biǎndī" },
            { option: "B", answer: "uplift", chinese_answer: "提升", chinese_romanization: "tíshēng" },
            { option: "C", answer: "simplify", chinese_answer: "简化", chinese_romanization: "jiǎnhuà" },
            { option: "D", answer: "ignore", chinese_answer: "忽视", chinese_romanization: "hūshì" }
        ],
        correctAnswer: "A",
        explanation: "(A) 'demean' means to cause a severe loss in the dignity of and respect for (someone or something)." +
            "<br><br>" +
            "(B) 'uplift' means to raise the level of; improve." +
            "<br><br>" +
            "(C) 'simplify' means to make (something) simpler or easier to do or understand." +
            "<br><br>" +

...
var questions = [
    ...
    {
        id: 10,
    question: "The __________ of his behavior at the workplace led to multiple complaints from his colleagues.",
    chinese_question: "他在工作中的行为 __________ 导致了同事们的多次投诉。",
    answers: [
        { option: "A", answer: "recklessness", chinese_answer: "鲁莽", chinese_romanization: "lǔmǎng" },
        { option: "B", answer: "professionalism", chinese_answer: "专业精神", chinese_romanization: "zhuānyè jīngshén" },
    ...
    explanation: "(A) 'recklessness' means lack of regard for the danger or consequences of one's actions." +
        "<br><br>" +
        "(B) 'professionalism' means the competence or skill expected of a professional." +
        "<br><br>" +
    ...
    chinese_explanation: "(A) '鲁莽' 意味着对危险或后果缺乏关注。" +
        "<br><br>" +
        "(B) '专业精神' 意味着专业人员应具备的能力或技能。" +
        "<br><br>" +
        "(C) '尊重' 意味着对某人或某事的深深钦佩之情。" +
        "<br><br>" +
        "(D) '礼貌' 意味着对他人的态度和行为的礼貌表现。"
    }
];

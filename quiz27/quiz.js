...
var questions = [
    ...
    {
        id: 3,
    question: "The professor's __________ was evident in his detailed lectures and extensive knowledge on the subject.",
    chinese_question: "教授的 __________ 在他详细的讲座和广博的学识中显而易见。",
    answers: [
        ...
        { option: "D", answer: "erudition", chinese_answer: "博学", chinese_romanization: "bóxué" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'erudition' means the quality of having or showing great knowledge or learning; scholarship." +
        "<br><br>" +
        ...
        "<br><br>" +
        "(C) 'mediocrity' means the quality or state of being mediocre.",
    chinese_explanation: "(D) '博学' 意味着具有或显示出渊博知识或学问的质量；学术。" +
        "<br><br>" +
        "(A) '无知' 意味着缺乏知识或信息。" +
        "<br><br>" +
    ...
    {
        id: 5,
    question: "The __________ goal of the project is to improve access to clean water for all residents in the region.",
    chinese_question: "该项目的 __________ 目标是改善该地区所有居民的清洁水供应。",
    answers: [
        { option: "A", answer: "initial", chinese_answer: "最初的", chinese_romanization: "zuìchū de" },
        { option: "B", answer: "secondary", chinese_answer: "次要的", chinese_romanization: "cìyào de" },
        { option: "C", answer: "preliminary", chinese_answer: "初步的", chinese_romanization: "chūbù de" },
    ...
    explanation: "(D) 'ultimate' means being or happening at the end of a process; final." +
        "<br><br>" +
        "(A) 'initial' means occurring at the beginning." +
        "<br><br>" +
        "(B) 'secondary' means coming after, less important than, or resulting from someone or something else that is primary." +
        "<br><br>" +
        "(C) 'preliminary' means denoting an action or event preceding or done in preparation for something fuller or more important.",
    chinese_explanation: "(D) '最终的' 意味着发生在过程结束时的；最终的。" +
        "<br><br>" +
        "(A) '最初的' 意味着发生在开始时的。" +
        "<br><br>" +
        "(B) '次要的' 意味着在某人或某物之后发生的，重要性较低的，或由主要的某人或某物引起的。" +
        "<br><br>" +
        "(C) '初步的' 意味着表示先于或为更全面或更重要的事物做准备的行动或事件。"
    },
    {
        id: 6,
    ...
    {
        id: 8,
    question: "His __________ workout routine left him feeling energized and strong every day.",
    chinese_question: "他每天的 __________ 锻炼让他感到精力充沛和强壮。",
    answers: [
        ...
        { option: "D", answer: "vigorous", chinese_answer: "有活力的", chinese_romanization: "yǒu huólì de" }
    ],
    correctAnswer: "D",
    explanation: "(D) 'vigorous' means strong, healthy, and full of energy." +
        "<br><br>" +
    ...
    chinese_explanation: "(D) '有活力的' 意味着强壮、健康且充满活力的。" +
        "<br><br>" +
        "(A) '懒惰的' 意味着不愿工作或使用精力的。" +
        "<br><br>" +

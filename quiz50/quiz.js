...
var questions = [
    ...
    {
        id: 6,
        question: "The project required an __________ amount of time and resources to complete.",
        chinese_question: "这个项目需要 __________ 的时间和资源来完成。",
        answers: [
    ...
    {
        id: 8,
        question: "The __________ child complained incessantly about everything, making it difficult for the parents to enjoy the day.",
        chinese_question: "那个 __________ 的孩子对所有事情都不断抱怨，让父母难以享受这一天。",
        answers: [
            { option: "A", answer: "cheerful", chinese_answer: "快乐的", chinese_romanization: "kuàilè de" },
            { option: "B", answer: "patient", chinese_answer: "耐心的", chinese_romanization: "nàixīn de" },
            { option: "C", answer: "peevish", chinese_answer: "易怒的", chinese_romanization: "yìnù de" },
            { option: "D", answer: "content", chinese_answer: "满意的", chinese_romanization: "mǎnyì de" }
        ],
        correctAnswer: "C",
        explanation: "(C) 'peevish' means easily irritated, especially by unimportant things." +
            "<br><br>" +
        ...
        chinese_explanation: "(C) '易怒的' 意味着特别容易被琐碎的事情激怒。" +
            "<br><br>" +
            "(A) '快乐的' 意味着明显的幸福和乐观。" +
            "<br><br>" +
            "(B) '耐心的' 意味着能够接受或忍受延误、问题或痛苦而不变得恼火或焦虑。" +
            "<br><br>" +
            "(D) '满意的' 意味着处于和平幸福的状态。"
    },
    {

...
var questions = [
    ...
    {
        id: 8,
        question: "The zoo's new __________ featured exotic animals from all over the world that fascinated visitors with their unique appearances and behaviors.",
        chinese_question: "动物园的新 __________ 展出了来自世界各地的奇异动物，这些动物以其独特的外貌和行为让游客着迷。",
        answers: [
            { option: "A", answer: "curation", chinese答案: "策展", chinese romanization: "cèzhǎn" },
            { option: "B", answer: "menagerie", chinese答案: "动物园", chinese romanization: "dòngwùyuán" },
            { option: "C", answer: "sanctuary", chinese答案: "避难所", chinese romanization: "bìnànsuǒ" },
            { option: "D", answer: "aviary", chinese答案: "鸟舍", chinese romanization: "niǎoshè" }
        ],
        correctAnswer: "B",
        explanation: "(B) 'menagerie' means a collection of wild animals kept in captivity for exhibition." +
            "<br><br>" +
            "(A) 'curation' refers to the selection and organization of items, often in a museum or gallery context." +
            "<br><br>" +
            "(C) 'sanctuary' means a place of refuge or safety, often for animals." +
            "<br><br>" +
            "(D) 'aviary' means a large cage or enclosure for keeping birds。",
        chinese_explanation: "(B) '动物园'一词意味着为展览而圈养的野生动物的收藏。" +
            "<br><br>" +
            "(A) '策展' 是指物品的选择和组织，通常在博物馆或画廊的上下文中。" +
            "<br><br>" +
            "(C) '避难所' 意味着为动物提供避难或安全的地方。" +
            "<br><br>" +
            "(D) '鸟舍' 意味着用于饲养鸟类的大笼子或围栏。"
    },
    {
        id: 9,

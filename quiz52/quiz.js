...
var questions = [
    ...
    {
        id: 7,
        question: "The __________ goal of the project is to improve community health and wellness.",
        chinese_question: "项目的 __________ 目标是改善社区健康和福祉。",
        answers: [
    ...
    {
        id: 9,
        question: "When she heard the news, her reaction was one of being __________; she stood still, unsure of what to say or do.",
        chinese_question: "当她听到这个消息时，她的反应是 __________ ；她站在那里，不知道该说什么或做什么。",
        answers: [
            { option: "A", answer: "composed", chinese_answer: "镇定", chinese_romanization: "zhèndìng" },
            ...
            { option: "D", answer: "nonplused", chinese_answer: "使困惑", chinese_romanization: "shǐ kùnhuò" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'nonplused' means to surprise and confuse someone so much that they are unsure how to react." +
            "<br><br>" +
            "(A) 'composed' means to be calm and in control of oneself." +
            "<br><br>" +
            "(B) 'amused' means finding something funny or entertaining." +
            "<br><br>" +
            "(C) 'delighted' means feeling great pleasure.",
        chinese_explanation: "(D) '使困惑' 意味着让某人感到惊讶和困惑，以至于他们不确定如何反应。" +
            "<br><br>" +
            "(A) '镇定' 意味着冷静和控制自己。" +
            "<br><br>" +
            "(B) '有趣' 意味着觉得某事有趣或娱乐性。" +

...
var questions = [
    ...
    {
        id: 4,
        question: "The community __________ the closure of the local library, a cherished institution.",
        chinese_question: "社区 __________ 本地图书馆的关闭，这是一所备受珍爱的机构。",
        answers: [
    ...
    {
        id: 6,
    question: "The difficult question during the interview seemed to __________ the candidate.",
    chinese_question: "面试中的这个难题似乎让这位候选人感到 __________。",
    answers: [

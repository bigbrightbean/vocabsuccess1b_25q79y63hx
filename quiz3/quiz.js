...
var questions = [
    {
        ...
        chinese_explanation: "(C) '指数的' 意味着（增长）越来越迅速的。" +
            "<br><br>" +
            "(A) '线性的' 意味着沿着直线或几乎直线排列的。" +
            "<br><br>" +
            "(B) '缓慢的' 意味着以缓慢速度移动或操作的。" +
            "<br><br>" +
            "(D) '逐渐的' 意味着逐步或渐进地进行的。"
    },
    {
        ...
        explanation: "(B) 'versatile' means able to adapt or be adapted to many different functions or activities." +
            ...
            "<br><br>" +
            "(D) 'specialized' means requiring or involving detailed and specific knowledge or training.",
        chinese_explanation: "(B) '多才多艺的'一词意味着能够适应或被适应于许多不同的功能或活动的。" +
            "<br><br>" +
            "(A) '有限的' 意味着在大小、数量或范围上受到限制的。" +
            "<br><br>" +
            "(C) '狭窄的' 意味着相对于长度而言宽度较小的。" +
            "<br><br>" +
            "(D) '专门的' 意味着需要或涉及详细和特定知识或培训的。"
    },
    {
        id: 3,
    ...
    {
        id: 6,
        question: "His __________ enthusiasm for the project sometimes annoyed his coworkers.",
        chinese_question: "他对项目的__________热情有时会惹恼同事。",
        answers: [

...
var questions = [
    ...
    {
        id: 2,
        question: "The company offered generous __________ to the employees who worked overtime during the holiday season, including bonuses and extra vacation days.",
        chinese_question: "公司向在假期期间加班的员工提供了丰厚的 __________，包括奖金和额外的假期。",
        answers: [
            ...
            { option: "D", answer: "compensation", chinese_answer: "补偿", chinese_romanization: "bǔcháng" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'compensation' means something, typically money, awarded to someone in recognition of loss, suffering, or work done." +
            "<br><br>" +
        ...
        chinese_explanation: "(D) '补偿' 意味着通常是金钱，作为对损失、痛苦或完成工作的认可而授予某人的东西。" +
            "<br><br>" +
            "(A) '批评' 意味着基于感知的错误或错误的表达不赞成。" +
            "<br><br>" +
            "(B) '忽视' 意味着未能适当照顾。" +
            "<br><br>" +

...
var questions = [
    ...
    {
        id: 2,
    question: "He tried to __________ the conversation away from controversial topics, by introducing neutral subjects like the weather and sports.",
    chinese_question: "他试图将对话 __________ 离开有争议的话题，通过引入诸如天气和体育之类的中立话题。",
    answers: [
    ...
    {
        id: 3,
        question: "The doctor prescribed medication to __________ the patient's pain after the surgery, by providing relief from the symptoms.",
        chinese_question: "医生开了药来 __________ 病人手术后的疼痛，通过缓解症状。",
        answers: [
                ...
                { option: "D", answer: "palliate", chinese_answer: "缓解", chinese_romanization: "huǎnjiě" }
        ],
        correctAnswer: "D",
        explanation: "(D) 'palliate' means to make a disease or its symptoms less severe without removing the cause." +
            ...
            "<br><br>" +
            "(C) 'reduce' means to make something smaller or less in amount, degree, or size.",
        chinese_explanation: "(D) '缓解'一词意味着在不消除原因的情况下减轻疾病或其症状的严重程度。" +
            "<br><br>" +
            "(A) '加重' 意味着使问题、伤害或罪行变得更严重。" +
            "<br><br>" +
            "(B) '加剧' 意味着变得或使更强烈。" +
            "<br><br>" +
            "(C) '减少' 意味着使某物在数量、程度或大小上变得更小。"
    },
    {
        id: 4,
        question: "The keynote speaker took the opportunity to __________ on the importance of sustainable development, by offering detailed insights and solutions.",
        chinese_question: "主讲人在演讲中借机 __________ 可持续发展的重要性，通过提供详细的见解和解决方案。",
        answers: [
        ...
        correctAnswer: "D",
        explanation: "(D) 'expatiate' means to speak or write at length or in detail about a subject." +
            "<br><br>" +
            "(A) 'summarize' means to give a brief statement of the main points." +
            "<br><br>" +
            "(B) 'simplify' means to make something simpler or easier to understand." +
            "<br><br>" +
            "(C) 'highlight' means to emphasize or make something stand out.",
        chinese_explanation: "(D) '详述' 意味着长篇大论地或详细地谈论一个主题。" +
            "<br><br>" +
            "(A) '总结' 意味着简要陈述要点。" +
            "<br><br>" +
            "(B) '简化' 意味着使某事更简单或更容易理解。" +
            "<br><br>" +
            "(C) '强调' 意味着突出或使某事突出。"
    },
    {
    ...
    {
        id: 7,
        question: "The long hike began to __________ their energy reserves and left them feeling exhausted.",
        chinese_question: "长时间的徒步旅行开始 __________ 他们的能量储备，让他们感到筋疲力尽。",
        answers: [
        ...
        correctAnswer: "C",
        explanation: "(C) 'deplete' means to use up the supply or resources of." +
            "<br><br>" +
            "(A) 'increase' means to become or make greater in size, amount, or degree." +
            "<br><br>" +
            "(B) 'maintain' means to keep in an existing state." +
            "<br><br>" +
            "(D) 'restore' means to bring back to a former condition, place, or position.",
        chinese_explanation: "(C) '耗尽' 意味着用尽供应或资源。" +
            "<br><br>" +
            "(A) '增加' 意味着在大小、数量或程度上增加。" +
            "<br><br>" +
            "(B) '维持' 意味着保持现有状态。" +
            "<br><br>" +
            "(D) '恢复' 意味着恢复到以前的状态、位置或位置。"
    },
    {
        id: 8,
    ...
    answers: [
        ...
        { option: "C", answer: "inflected", chinese_answer: "变化", chinese_romanization: "biànhuà" },
        { option: "D", answer: "diminished", chinese_answer: "减少", chinese_romanization: "jiǎnshǎo" }
    ],
    correctAnswer: "C",
    explanation: "(C) 'inflected' means to change the pitch or tone of the voice." +
        "<br><br>" +
        ...
        "<br><br>" +
        "(D) 'diminished' means made smaller or less.",
    chinese_explanation: "(C) '变化' 意味着改变声音的音高或音调。" +
        "<br><br>" +
        "(A) '支持' 意味着给予帮助。" +
        "<br><br>" +
